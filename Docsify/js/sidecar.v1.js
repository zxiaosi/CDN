...
var sidecar = function (t) {
    ...
    var n = Object.assign || function (t) {
        ...
        d = new a.default("gitter-sidecar-ready", {
            detail: s
        });
    if (document.dispatchEvent(d), !((l.chat || {}).options || {}).disableDefaultChat) {
        var L = c(l, "chat");
        L.defaultChat = new M.default(L.options || {})
    }
    e.default = s
}, function (t, e) {
    "use strict";
    ...
    function i(t, e) {
        var i = e.bubbles,
            ...
            M = void 0;
        try {
            M = new window.CustomEvent(t, {
                bubbles: r,
                cancelable: o,
                detail: u
            })
        } catch (e) {
            M = document.createEvent("CustomEvent"), M.initCustomEvent(t, r, o, u)
        }
        return M
    }
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.default = i, i.prototype = window.Event.prototype
}, function (t, e) {
    "use strict";
    ...
    var a = function () {
        ...
        z = function (t, e) {
            t = (0, x.default)(t);
            var i = function (t) {
                if ("click" === t.type || "keydown" === t.type && (t.keyCode === E || t.keyCode === D)) {
                    for (var i = arguments.length, r = Array(i > 1 ? i - 1 : 0), n = 1; n < i; n++) r[n -
                        1] = arguments[n];
                    e.call.apply(e, [this, t].concat(r))
                }
            };
            return x.on(t, "click keydown", i),
                function () {
                    x.off(t, "click keydown", i)
                }
        },
        h = function () {
            var t = new L.default,
                e = t.createElement("style");
            return e.type = "text/css", e.innerHTML = f.default, x.prependElementTo(e, (0, x.default)(
                "head")[0]), t
        },
        w = function (t) {
            var e = new L.default,
            ...
            return i.forEach(function (i) {
                ...
                if (r.room) {
                    ...
                    n.setAttribute("frameborder", "0"), n.src = "" + t.host + r.room + "/~embed", i
                        .appendChild(n)
                } else console.error("Gitter Sidecar: No room specified for targetElement", i)
            }), e
        },
        p = function (t) {
            var e = t.options,
                i = new L.default;
            return e.targetElement.forEach(function (r) {
                var n = i.createElement("div");
                n.classList.add("gitter-chat-embed-action-bar"), r.insertBefore(n, r.firstChild);
                var o = i.createElement("a");
                o.classList.add("gitter-chat-embed-action-bar-item"), o.classList.add(
                    "gitter-chat-embed-action-bar-item-pop-out"), o.setAttribute("aria-label",
                    "Open Chat in Gitter.im"), o.setAttribute("href", "" + e.host + e.room), o.setAttribute(
                    "target", "_blank"), o.setAttribute("rel", "noopener"), n.appendChild(o);
                var a = i.createElement("button");
                a.classList.add("gitter-chat-embed-action-bar-item"), a.classList.add(
                    "gitter-chat-embed-action-bar-item-collapse-chat"), a.setAttribute(
                    "aria-label", "Collapse Gitter Chat"), z(a, function (e) {
        ...
        Q = function () {
            function t() {
                ...
                o(this, t), this[C] = new L.default, this[S] = [], this[I] = v, this[A] = u({}, this[I], e),
                    this[O]()
            }
            return a(t, [{
                key: O,
                value: function () {
                    var t = this,
                        e = this[A];
                    e.useStyles && this[C].add(h()), e.targetElement = (0, x.default)(e.targetElement ||
                            function () {
                                var e = t[C].createElement("aside");
                                return e.classList.add("gitter-chat-embed"), e.classList.add(
                                    "is-collapsed"), m.appendChild(e), e
                            }()), e.targetElement.forEach(function (e) {
                            var i = t[C].createElement("div");
                        ...
                        }), p(this), e.preload && this.toggleChat(!1), e.showChatByDefault ?
                        this.toggleChat(!0) : (void 0 === e.activationElement || e.activationElement ===
                            !0 ? e.activationElement = (0, x.default)(function () {
                                var i = t[C].createElement("a");
                                return i.href = "" + e.host + e.room, i.innerHTML =
                                    "Open Chat", i.classList.add(
                                        "gitter-open-chat-button"), m.appendChild(i), i
                            }()) : e.activationElement && (e.activationElement = (0, x.default)
                                (e.activationElement)), e.activationElement && (z(e.activationElement,
                                function (e) {
                                    t.toggleChat(!0), e.preventDefault()
                                }), e.targetElement.forEach(function (t) {
                                x.on(t, "gitter-chat-toggle", function (t) {
                                    var i = t.detail.state;
                    ...
                    var i = z((0, x.default)(".js-gitter-toggle-chat-button"), function (e) {
                        var i = T(e.target.getAttribute(
                            "data-gitter-toggle-chat-state"));
                        t.toggleChat(null !== i ? i : "toggle"), e.preventDefault()
                    });
                    this[S].push(i), e.targetElement.forEach(function (e) {
                        var i = new l.default("gitter-chat-started", {
                            detail: {
                                chat: t
                            }
                        });
                    ...
                    var r = new l.default("gitter-sidecar-instance-started", {
                        detail: {
                            chat: this
                        }
                    });
                ...
                value: function (t) {
                    var e = this[A];
                    e.targetElement || console.warn(
                        "Gitter Sidecar: No chat embed elements to toggle visibility on"
                    );
                    var i = e.targetElement;
                    i.forEach(function (e) {
                        "toggle" === t ? x.toggleClass(e, "is-collapsed") : x.toggleClass(
                            e, "is-collapsed", !t);
                        var i = new l.default("gitter-chat-toggle", {
                            detail: {
                                state: t
                            }
                        });
                ...
                value: function (t) {
                    var e = this,
                        i = this[A];
                    if (t && !this[k]) {
                        var r = i.targetElement;
                        r.forEach(function (t) {
                            t.classList.add("is-loading")
                        }), setTimeout(function () {
                            e[U](), e[Y](t), r.forEach(function (t) {
                                t.classList.remove("is-loading")
                            })
                        }, 300)
                    } else this[U](), this[Y](t)
                }
            }, {
                key: "destroy",
                value: function () {
    ...
    function u(t, e, i) {
        return void 0 !== i ? i ? t.classList.add(e) : t.classList.remove(e) : t.classList.toggle(e), i
    }
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.forEach = r, e.on = n, e.off = o, e.prependElementTo = a, e.toggleClass = u;
    var M = function () {
            for (var t = arguments.length, e = Array(t), i = 0; i < t; i++) e[i] = arguments[i];
            return e.reduce(function (t, e) {
                return !e || void 0 === e.length || Array.isArray(e) || window && (!window || e instanceof window
                    .constructor) || (e = Array.prototype.slice.call(e)), t.concat(e)
            }, [])
        },
        c = function () {
            ...
            if ("string" == typeof e[0]) {
                var o;
                n = (o = document.querySelectorAll).call.apply(o, [document].concat(e))
            }
            return M.apply(void 0, i(n))
        },
        s = function () {
    ...
    var r = function () {
        ...
        o = function () {
            function t() {
                i(this, t), this.elements = []
            }
            return r(t, [{
                key: "createElement",
                value: function () {
                    for (var t = arguments.length, e = Array(t), i = 0; i < t; i++) e[i] =
                        arguments[i];
                    var r = document.createElement.apply(document, e);
                    return this.add(r), r
                }
            }, {
                key: "add",
                value: function () {
                    for (var e = arguments.length, i = Array(e), r = 0; r < e; r++) i[r] =
                        arguments[r];
                    var n = [].concat(i).reduce(function (e, i) {
                        return i ? i instanceof t ? e.concat(i.elements) : e.concat(
                            i) : e
                    }, []);
    ...
    t.exports = function () {
        ...
        return t.toString = function () {
            ...
            for (n = 0; n < e.length; n++) {
                var a = e[n];
                "number" == typeof a[0] && r[a[0]] || (i && !a[2] ? a[2] = i : i && (a[2] = "(" + a[
                    2] + ") and (" + i + ")"), t.push(a))
            }
        }, t
    }
